...
from constants import DATA_CSV_PATH_FULL_CSV, DATA_CSV_PATH_FULL_PICKLE
from data.schema.recipe import RecipeModel
...
class BBCRecipesParses(RecipeParser):
    ...
    def parse_recipes(self, url: str = URL) -> List[RecipeModel]:
        input_recipes = []
        ...
        for page in range(66, pages):
            ...
            input_recipes = input_recipes + temp
            # todo del
    ...
    def generate_dataset(self, url: str, basic_url: str = BASIC_URL) -> List[RecipeModel]:
        result = []
        ...
        for article in articles:
            ...
            try:
                result.append(self.get_recipes_from_page(recipe_parser, recipe_title))
            except:
                # TODO
    ...
    def get_recipes_from_page(self, recipe_parser: bs4.BeautifulSoup, recipe_title: str) -> RecipeModel:
        tags = json.loads(
...
if __name__ == "__main__":
    ...
    # PICKLE
    # joblib.dump(data, DATA_CSV_PATH_FULL_PICKLE)
    # data = joblib.load(DATA_CSV_PATH_FULL_PICKLE)
